...
class _SignupState extends State<Signup> {
  ...
  void _signup() async {
    ...
    if (_pass.text != _cpass.text) {
      ...
      try {
        ...
        showSnackbar('berhasil daftar, login sekarang');
  ...
  showSnackbar(message) {
    _scaffoldkey.currentState.showSnackBar(SnackBar(
      ...
      content: Text(message ?? "Terjadi kesalahan, coba lagi nanti"),
    ));
  }
      ...
      child: Column(
        children: <Widget>[
          ...
          CustomTextField(
            ...
            onValidate: (value) {
              if (value.length != 10)
                return 'Nomer telepon harus 10 digit';
              else if (value.isEmpty) return 'Wajib diisi!';
            },
            label: 'Contact',
            hint: 'Ex:9880124587',
          ),
